...
SMOKE_CLASS="${SMOKE_CLASS:-com.bockmedia.console.smoke.BockDeviceSmokeTest}"
...
echo "Running smoke tests ($SMOKE_CLASS) on $SERIAL …"
...
"$REPO_ROOT/scripts/mobile_ui_collect_crashes.sh" || exit 1
