...
#ifndef BOCKMEDIA_SWIFT_H
#define BOCKMEDIA_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="BockMedia",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSString;
SWIFT_CLASS("_TtC9BockMedia11AppDelegate")
...
@interface AppDelegate (SWIFT_EXTENSION(BockMedia)) <UNUserNotificationCenterDelegate>
- (void)userNotificationCenter:(UNUserNotificationCenter * _Nonnull)center didReceiveNotificationResponse:(UNNotificationResponse * _Nonnull)response withCompletionHandler:(void (^ _Nonnull)(void))completionHandler;
- (void)userNotificationCenter:(UNUserNotificationCenter * _Nonnull)center willPresentNotification:(UNNotification * _Nonnull)notification withCompletionHandler:(void (^ _Nonnull)(UNNotificationPresentationOptions))completionHandler;
@end

/// Wraps a <code>URLSessionConfiguration.background</code> session so offline downloads
...
/// (<code>@MainActor</code>) <code>OfflineDownloadManager</code> via <code>.offlineDownloadTaskFinished</code>.
SWIFT_CLASS("_TtC9BockMedia24OfflineBackgroundSession")
@interface OfflineBackgroundSession : NSObject
...
@interface OfflineBackgroundSession (SWIFT_EXTENSION(BockMedia)) <NSURLSessionDownloadDelegate>
