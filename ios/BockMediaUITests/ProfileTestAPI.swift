...
enum ProfileTestAPI {
    ...
    private enum ConfigError: Error, CustomStringConvertible {
        ...
        var description: String {
            switch self {
            case .missingServerURL: return "BOCK_TEST_SERVER_URL not set (Config.xcconfig or env)"
            case .missingToken: return "BOCK_TEST_API_TOKEN not set (Config.xcconfig or env)"
            }
        }
    }
