...
&nbsp;·&nbsp; Python 3.10+ &nbsp;·&nbsp; Flask &nbsp;·&nbsp; vanilla-JS admin console &nbsp;·&nbsp; custom Alexa skill
...
> (`scripts/seed_demo_data.py`) — the library, devices, and listening history
> are entirely fictional.

### Dashboard
At-a-glance library counts, a copy-pasteable voice-command cheat sheet, and recent Alexa play requests.
...
A single-page app with a dark sidebar and 12 pages — Dashboard, Now Playing,
Playlists, Albums, Artists, Songs, Watch Folders, Alexa Devices, Automation,
Routines, Analytics, Settings — all backed by JSON endpoints. Includes:
...
├── RUNBOOK.md                    # operations runbook (sanitized)
...
The full operations runbook with every known gotcha is in
